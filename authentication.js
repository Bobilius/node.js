...
exports.signup = async (req, res) => {
  if(!req.body.password || req.body.password.length < 6 || typeof(req.body.password) !== "string"){
    res.status(400)
      .send({
        message: "must provie a password as a string and it must be at least 6 characters long"
      });
    return;
  }
